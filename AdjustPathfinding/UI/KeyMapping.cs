...
namespace AdjustPathfinding.UI
{
    ...
    public class OptionsKeymapping : UICustomControl
    {
        ...
        private void Awake()
        {
            AddKeymapping("Mod shortcut", ModInfo.ModShortcut);
            /*this.AddKeymapping("Toggle Anarchy", OptionsKeymapping.toggleAnarchy);
            this.AddKeymapping("Toggle Bending", OptionsKeymapping.toggleBending);
            this.AddKeymapping("Toggle Snapping", OptionsKeymapping.toggleSnapping);
            this.AddKeymapping("Toggle Collision", OptionsKeymapping.toggleCollision);
            this.AddKeymapping("Toggle Editor Grid", OptionsKeymapping.toggleGrid);*/
        }
