...
namespace AdjustPathfinding.Util
{
    /* By Strad, 2019 */
    ...
    public static class NetUtil
    {
        ...
        {
            return (segment.m_flags & NetSegment.Flags.Created) != NetSegment.Flags.None && (segment.m_flags & NetSegment.Flags.Deleted) == NetSegment.Flags.None;
        }
